            ...
            <div class="containers">
                <form action="stud-edit.php" method="post" id="student-apply">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="username" name="userid" disabled value="<?php echo $row['user_id']; ?>">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">First Name</label>
                        <input type="text" class="form-control" id="firstname" name="firstname" value="<?php echo $row['fname']; ?>" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="registration_number" name="regno" value="<?php echo $row['regno']; ?>" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="yearofstudy" name="yearofstudy" value="<?php echo $row['year_of_study']; ?>" required>
                    </div>
                    <br>
